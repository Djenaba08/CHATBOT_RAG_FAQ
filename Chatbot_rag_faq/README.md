...
Ce projet met en œuvre un système de **Retrieval-Augmented Generation (RAG)** permettant de poser des questions en langage naturel sur un document PDF volumineux (+100 pages) et d'obtenir des réponses basées sur le contexte extrait.
